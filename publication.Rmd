...
This case study presents a small subset of data from a current study conducted at the Department of Geography at the University of Zurich. The study investigates the development of a second Swiss National Park, the _Adula Parc_. 

### Exploratory topic analysis

For this case study, 16 interviews were carried out. Each of these guided interviews was annotated based on a predefined topic tree. The following plots display sample output from the MXAQDA software for qualitative data analysis.

Overview of the interviews and representatives:

* _Cantonal Goverment_ (n: 4): Representatives from four different departments
* _Environmental Organisation_ (n: 1): Involved as a stakeholder in the park planning
* _Federal Goverment_ (n: 2): Must ensure the park follows the 'Natur- und Heimatschutz' regulations
* _Local_ (n: 5): Local representatives of the park region
* _Parc Team_ (n: 2): Team members involved in the park planning
...
Parc Adula is situated in Switzerland in the border region of the cantons Ticino and Grisons (Graubünden). The map below presents the current outer perimiter of the planned national park.
